...
class Correo
{
  ...
  /*  private static function SendMAIL($para,$subject,$body,$altbody,$mailFROM,$mailNameCompany, $AddCC = false, $addFiles=false)
    ...
    public static function sendMail($mailBody, $to, $name, $subject, $from, $fromName = "Marco Bautista", $AddCC = false )
    {
        ...
        $mail           = new \PHPMailer();
        $mail->From     = $from;
        $mail->FromName = "=?ISO-8859-1?B?" . base64_encode(utf8_decode($fromName)) . "=?=";
